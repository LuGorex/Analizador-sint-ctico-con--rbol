...
class R6():
    ...
    def getInfo(self,ambito,o1=0):
            ...
            if (len(Exist)>0):
                messagebox.showinfo('Mensaje', Exist)
                sys.exit(1)
...
class R8():
    ...
    def getInfo(self,ambito,tipo):
        ...
        if (len(comp) > 0):
            messagebox.showinfo('Mensaje', comp)
            sys.exit(1)
...
class R36():
    ...
    def getInfo(self,ambito,tipo):
        ...
        if (tipe != tipo  and tipo!="all"):
            messagebox.showinfo('Mensaje', "Error de asignación o retorno de variable " + tipo + " con " + tipe)
            sys.exit(1)
...
class R38():
    ...
    def getInfo(self,ambito,tipo):
        ...
        if (tipo != "float" and tipo!="all"):
            messagebox.showinfo('Mensaje',"Error de asiognacion o retorno de variable "+tipo +" con float")
            sys.exit(1)
        return "float"
...
class R40():
    ...
    def getInfo(self,ambito,tipo):
        ...
        if (tipe!=tipo and tipo!="all"):
            messagebox.showinfo(self,'Mensaje',"La funcion "+self.identificador + " no es de tipo " + tipo)
            sys.exit(1)
